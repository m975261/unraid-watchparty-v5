...
## Docker Image
```
docker pull muaeabudhabi/watchparty-v5:latest
```

## Install on Unraid
1. Download `unraid-templates/my-watchparty-v5.xml`
2. Copy to `/boot/config/plugins/dockerMan/templates-user/`
3. Docker tab → Add Container → select `watchparty-v5`
